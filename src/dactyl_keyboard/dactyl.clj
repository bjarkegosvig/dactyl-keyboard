; using Loligagger's V2 version of the script from
; https://geekhack.org/index.php?topic=88576.0;all
; for direct download of the script use https://geekhack.org/index.php?action=dlattach;topic=88576.0;attach=233393
; I have modified it to compile, there were some define problems, so some defines have been moved to the top of the script
